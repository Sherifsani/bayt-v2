...
const FeaturedWorks = () => {
  ...
  return (
    <section className="w-full py-12 md:py-16 px-4 md:px-0 max-w-[1200px] mx-auto">
      <div className="w-full flex justify-between items-center  text-gray-300">
        <h3 className="text-xl font-bold text-black ">Selected Projects</h3>
        <Link
          href="/projects"
          className="text-sm text-black hover:bg-white/50 transition-colors duration-200 border border-gray-600/40 hover:border-gray-500/60 px-4 py-2 rounded-lg backdrop-blur-sm bg-white"
        >
          All projects
        </Link>
      </div>
      <div className="p-3 border border-dashed border-gray-700/40 rounded-lg h-[350px] flex flex-col md:flex-row items-center justify-between gap-4 mt-6 ">
        <ProjectCard />
        <ProjectCard />
        <ProjectCard />
      </div>
